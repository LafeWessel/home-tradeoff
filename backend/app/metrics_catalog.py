...
CATALOG: list[MetricDef] = [
    ...
    MetricDef(
        ...
        source_label="EIA Form 861 (curated)",
        finest_level="state",
    ),
    MetricDef(
        key="infra.broadband_100_20_pct",
        label="Broadband 100/20 access",
        category="utilities",
        unit="%",
        direction=MetricDirection.higher_better,
        description="Share of households with access to wired broadband ≥ 100 Mbps down / 20 Mbps up.",
        source_label="FCC BDC (curated)",
        finest_level="state",
    ),
    MetricDef(
